...
#define NODE_MAIN_LOGGER_NAME "bridge_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libros_gz_bridge.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ros_gz_bridge::RosGzBridge>";
