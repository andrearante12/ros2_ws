...
static char moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__smoothness_level[] = "smoothness_level";
...
static rosidl_runtime_c__type_description__Field moveit_msgs__msg__MotionPlanRequest__FIELDS[] = {
  ...
  {
    {moveit_msgs__msg__MotionPlanRequest__FIELD_NAME__smoothness_level, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {moveit_msgs__msg__MotionPlanRequest__FIELDS, 16, 16},
    },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {moveit_msgs__msg__MotionPlanRequest__TYPE_NAME, 33, 33},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 2662, 2662},
  };
  return &source;
}
